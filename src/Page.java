...
public class Page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        frame.setTitle(Splash.titleGet());
        ...
        frameLayout.setVerticalGroup(
            frameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(body, javax.swing.GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE)
        );
    ...
    /**
     * Method to set the title on the frame
     * PRE: a string containing the title
     * POST: the title will be displayed on top of the frame 
    */
    ...
    /**
     * Method to display the website's body text
     * PRE: a string containing the text to display
     * POST: the text will be displayed on the frame 
     */
